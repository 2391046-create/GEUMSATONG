...
> *"LLM이 임의로 추측해 답변하지 않도록, 검증된 사실(Fact)만 제시합니다."*
...
* **Global Search (거시적 탐색):** 전체 금융 지식 그래프의 커뮤니티 구조를 분석하여, 복잡한 시장 동향이나 사기 수법의 전체적인 흐름을 요약·제공합니다.


---


### 🔗 4가지 노드의 Triple 구조 (Subject - Relationship - Object)
...
### 📐 기술 파이프라인 및 데이터 흐름 (Architecture)
...
[Microsoft GraphRAG 파이프라인] ── (settings.yaml & 커스텀 프롬프트)
       │
       ├─► [Entity & Relationship 추출] (4가지 노드의 Triple 구조로 분류)
       │
       ▼
